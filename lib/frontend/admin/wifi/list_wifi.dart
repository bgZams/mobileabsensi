...
class _WifiOpdState extends State<WifiOpd> {
  ...
  late final String username = SpUtil.getString("username") ?? '';
  ...
  void initState() {
    super.initState();
    _initNetworkInfo();
    searchData(username,selectedIdServer!);
  }
    ...
    try {
      ...
      if (dataWifi.statusCode == 200) {
        setState(() {
          ...
          searchData(username, serverName);
        });
        if (mounted) {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const WifiPenddingAdmin())),
                child: SizedBox(
                  width: 50,
                  child: Container(
