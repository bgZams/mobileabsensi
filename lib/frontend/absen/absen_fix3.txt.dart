...
class _AbsenState extends State<Absen> {
  ...
  Future<void> _disableScreenRecording() async {
    // Tidak ada cara langsung untuk melarang screen recording, namun kita dapat mencoba menggunakan kode berikut
  ...
  // Ambil semua nilai boolean dari SpUtil terlebih dahulu
    ...
    final statusIDLK = SpUtil.getBool('status_idlk') ?? false;
      ...
      if(isPulangCepat == true || isIDLK == true){
      ...
      } else if(SpUtil.getString('statusPC') == 'setujui'){
          return Card(
            color: Colors.green,
            child: Padding(
              padding: const EdgeInsets.all(16.0),
        ...
        } else if(SpUtil.getString('statusPC') == 'tolak'){
          return Card(
            color: Colors.red,
            child: Padding(
              padding: const EdgeInsets.all(16.0),
        ...
        else if(SpUtil.getBool('is_codeMasuk') == true && SpUtil.getBool('is_codePulang') == false){
          return Padding(
