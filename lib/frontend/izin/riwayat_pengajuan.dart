...
class _RiwayatPengajuanIzinState extends State<RiwayatPengajuanIzin> with TickerProviderStateMixin {
  ...
  Future<List<Map<String, dynamic>>> fetchData(
    ...
    var link = '$url/api/izin/riwayat-izin/pengajuan/$idUser/$monthNumber/$year';
